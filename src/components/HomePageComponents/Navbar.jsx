    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          {/* Logo */}
          <div className="flex-shrink-0 text-2xl font-semibold bg-gradient-to-b from-purple-800 via-purple-400 to-purple-600 bg-clip-text text-transparent">
            Sahayak AI
          </div>
          ...
          {/* Desktop CTA */}
          <div className="hidden md:block">
            <button className="border border-zinc-500 text-white px-6 py-2 rounded-full font-medium hover:shadow-lg hover:scale-105 transition-all duration-200">
              Get Started
            </button>
          </div>
      ...
      {menuOpen && (
        <div className="md:hidden px-4 pb-4 pt-2 space-y-2 bg-white dark:bg-zinc-900 border-t dark:border-zinc-700">
          ...
          <button className="w-full border border-zinc-500 text-white px-6 py-2 rounded-full font-medium hover:shadow-lg hover:scale-105 transition-all duration-200">
            Get Started
          </button>
        </div>
      )}
