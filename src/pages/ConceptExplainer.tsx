  ...
  const handleExplain = async () => {
    ...
    try {
      const result = await AIService.explainConceptAdaptively({
        ...
        language,
        learningStyle,
        previousQuestions: [] // Could be enhanced to track previous questions
      });
          ...
          <div className="bg-white/80 backdrop-blur-lg rounded-2xl shadow-xl border border-gray-200/50 p-6">
            ...
            <div className="mt-4">
              ...
              <div className="grid grid-cols-1 gap-2 max-h-48 overflow-y-auto">
                {currentSampleQuestions.map((sample, index) => (
                  <motion.button
                    key={index}
          ...
          <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl p-6 border border-green-200/50">
            ...
            <ul className="space-y-2 text-sm text-gray-700">
              <li className="flex items-start">
                ...
                Use simple analogies and real-world examples from students' daily lives
              </li>
              <li className="flex items-start">
                <span className="text-green-500 mr-2">•</span>
              ...
              <li className="flex items-start">
                <span className="text-green-500 mr-2">•</span>
                Encourage questions and foster curiosity in the classroom
              </li>
              <li className="flex items-start">
                <span className="text-green-500 mr-2">•</span>
                Adapt explanations based on students' learning styles
              </li>
              <li className="flex items-start">
                <span className="text-green-500 mr-2">•</span>
                Use visual aids and hands-on activities when possible
              </li>
            </ul>
          </div>
        </motion.div>
            ...
            {explanation ? (
              <div className="space-y-6">
                ...
                {explanation.nextTopics && explanation.nextTopics.length > 0 && (
                  <div className="bg-indigo-50 p-4 rounded-xl border border-indigo-200/50">
